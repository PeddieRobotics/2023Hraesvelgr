package frc.robot.utils.PathPlannerCopiedFiles;
...
public class FollowPathWithEventsButDontEndThemAtStopPoints extends CommandBase {
   ...
   *     following command.
   */
  public FollowPathWithEventsButDontEndThemAtStopPoints(
  ...
  public void end(boolean interrupted) {
    for (Map.Entry<Command, Boolean> runningCommand : currentCommands.entrySet()) {
      if (runningCommand.getValue()) {
        //runningCommand.getKey().end(true); - THE ONLY LINE CHANGED
      }
    }
  }
