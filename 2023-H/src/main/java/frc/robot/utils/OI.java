...
public class OI {
    ...
    public Translation2d getCardinalDirection(){
        ...
        switch (getDriverDPadInput()) {
            case FORWARDS:
                return new Translation2d(0.3 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed, 0.0 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed);
            case RIGHT:
                return new Translation2d(0.0 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed, -0.3 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed);
            case LEFT:
                return new Translation2d(0.0 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed, 0.3 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed);
            case BACKWARDS:
                return new Translation2d(-0.3 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed, 0.0 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed);
            default:
                return new Translation2d(0.0 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed, 0.0 * translation_speed_coeff * DriveConstants.kMaxFloorSpeed);
        }
